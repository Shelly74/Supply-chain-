...
![banner-supply-chain-management-vector-illustration-concept-icon-with-management-analysis-plan-product-procurement-logistic-distribution-2ed](https://github.com/user-atRBW8J0_enhanctachments/assets/17740f6b-ecbe-4ff9-8d56-511350b47e77)
...
- **Database**: MySQL
- **Programming Language**: SQL, tableau , powerbi , python 
- **Dataset**: `sales_test.csv` and `canceled_test.csv`etc.
...
[Linkedin](https://www.linkedin.com/in/shelly-garg-ms010190)
